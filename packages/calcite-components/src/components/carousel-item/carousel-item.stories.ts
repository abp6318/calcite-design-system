...
export default {
  title: "Components/Tips/CarouselItem",
  parameters: {
    ...
    [
      {
        name: "heading",
        commit(): Attribute {
          this.value = text("heading", "My CarouselItem");
          delete this.build;
          return this;
        }
      }
...
export const simple = (): string => create("calcite-carousel-item", createAttributes(), html);
